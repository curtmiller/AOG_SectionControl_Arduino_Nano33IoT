...
// Section Control code for AgOpenGPS V 4.3.10 (=V17) and V4.6 or later for Arduino Nano 33 IoT
...
byte vers_nr = 46;
char VersionTXT[150] = " - 11. Maerz 2021 by MTZ8302 WebIO by coffeetrac<br>(Nano 33Iot only, V4.6 ready, 2 WiFi networks)";
