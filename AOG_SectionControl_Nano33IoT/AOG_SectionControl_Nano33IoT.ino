...
struct set {
	...
	uint8_t DataTransVia = 0;			    //transfer data via 0 = USB / 7 = UDP
...
//Example2: PWM valve, with flowmeter all controled by AOG:   RateControl..Equiped = true; RateSW..Equiped = true; RateControlPWM = true;	
	...
	uint8_t SectNum = 3;					      // number of sections
...
// BELOW CONTAINS THE ORIGINAL USER SETTINGS BEFORE CURT TWEAKED THEM
// 	//User config: ***********************************************************************************
